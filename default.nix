let
  # Pin haskell-nix to a recent (as of 2022/01/06) commit
  h8x-pin = "https://github.com/input-output-hk/haskell.nix/archive/d94034dda2666b27676b75ebb9d66be0ea9ac464.tar.gz";
